...
class Employee{
  ...
  String mail_id;
  String mob_number;
  void Empolyee(String emp_name, int emp_id, String address, String mail_id, String mob_number)
{
...
class AssistantProfessor extends Employee{
  ...
  void AssitantProfessor(String emp_name, int emp_id, String address, String mail_id, String mob_number, double bp){
     super(emp_name,emp_id,address,mail_id,mob_number);
    basicpay=bp;
   }  
...
public class EmployeeMain{
  public static void main(String[] args){
     ...
     System.out.println("2. Assitant Professor");
     ...
     switch (desg){
       case 1:
          ...
          break;
      case 2:
          AssitantProfessor ap=new AssitantProfessor(name,id,add,mail,mob,bp);
          ap.getPaySlip();
          ap.disp();
          break;
      case 3:
